...
def animated_streaming_chat():
    """Main animated chatbot with Rich effects"""
    console = Console()
...
async def async_animated_chat():
    """Async version with even smoother animations"""
    console = Console()
    ...
    while True:
        try:
            ...
            with Live(console=console, refresh_per_second=30) as live:
                thinking_spinner = Spinner("aesthetic", text="Generating response...", style="magenta")
